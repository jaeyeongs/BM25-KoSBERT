...
def convert_transfo_xl_checkpoint_to_pytorch(
    ...
    if transfo_xl_dataset_file:
        ...
        # Save vocabulary and KorQuADDataset cache as Dictionaries (should be better than pickles for the long-term)
        ...
        print("Save KorQuADDataset to {}".format(pytorch_dataset_dump_path))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to the folder to store the PyTorch model or KorQuADDataset/vocab.",
    )
    parser.add_argument(
        "--tf_checkpoint_path",
        default="",
    ...
    parser.add_argument(
        ...
        default="",
        type=str,
        help="An optional KorQuADDataset file to be converted in a vocabulary.",
    )
